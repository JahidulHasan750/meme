function clearAll() {
    const imgExist = document.querySelector('.meme-content');
    const jokeExist = document.querySelector('.joke-content');
    const quoteExist = document.querySelector('.wise-content');
    const riddleExist = document.querySelector('.riddle-content');
  imgExist.innerHTML ='';
  jokeExist.innerHTML ='';
  quoteExist.innerHTML ='';
  riddleExist.innerHTML ='';
  }
  ...
  function showQuote() {
    ...
    clearAll();
    const container = document.querySelector('.wise-content');
  ...
  function revealAnswers() {
    ...
    if(riddle && answer.hidden){
      ...
      alert("There's no riddle to begin with");
    }
  }
